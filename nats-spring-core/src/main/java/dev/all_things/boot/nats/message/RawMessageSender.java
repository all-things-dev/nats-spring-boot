...
{
	private static final Logger logger = LoggerFactory.getLogger(RawMessageSender.class);

	protected final String replySubject;

	public RawMessageSender(final String replySubject)
	{
	...
	public void send(final Connection connection, final Message sourceMessage, final Object reply)
	{
		...
		connection.publish(subject, ((byte[]) reply));
	}
}
